...
// --- SAYFA BAŞLIK VERİLERİ (ERKEK) ---
const pageInfo = ref({
  breadcrumb: 'MENS',
  title: "MEN'S LATEST RELEASES",
  productCount: 'Loading...',
  description: 'Explore the latest men\'s gym clothes and workout wear.'
})

// --- 5'Lİ KATEGORİ VİTRİNİ (DB'den dolacak) ---
...
// -- DATA SETLERİ (ERKEKLERE UYARLANDI) --
const filterOptions = {
  productTypes: ['T-Shirts', 'Tank Tops', 'Stringers', 'Hoodies & Jackets', 'Shorts', 'Joggers', 'Base Layers', 'Underwear', 'Accessories'],
  sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'],
  features: ['Seamless', 'Sweat Wicking', 'Lightweight', 'Breathable', 'Muscle Fit', 'Oversized'],
  fits: ['Regular', 'Oversized', 'Muscle Fit', 'Slim', 'Compression'],
  activities: ['Lifting', 'Running', 'Rest Day', 'HIIT'],
  collections: ['Legacy', 'Power', 'Crest', 'Arrival', 'Apex', 'Critical', 'Bold', '315'],
  colors: [
    { name: 'Black', hex: '#000000' }, { name: 'White', hex: '#ffffff', border: true }, 
    { name: 'Grey', hex: '#808080' }, { name: 'Navy', hex: '#000080' }, 
    { name: 'Blue', hex: '#3b5998' }, { name: 'Green', hex: '#228b22' }, 
    { name: 'Red', hex: '#cc0000' }, { name: 'Khaki', hex: '#f0e68c' }
  ],
  prices: ['US$20 - US$30', 'US$30 - US$50', 'US$50 - US$75', 'US$75+']
}
...
const fetchProducts = async () => {
  try {
    loading.value = true
    // DİKKAT: 'menproducts' tablosundan çekiyoruz
    const querySnapshot = await getDocs(collection($db as any, 'menproducts'))
    ...
    querySnapshot.forEach((doc) => {
      ...
      fetchedData.push({
        ...
        tag: data.tag ? { text: data.tag, type: 'new' } : null
      })
    })

    products.value = fetchedData
    // İlk 5 ürünü vitrine koy
        ...
        <div class="products-grid-container">
          <div class="promo-banner">
            ...
            <div class="promo-text">
              <strong>GET HIM A GIFT CARD</strong>
              <p>The perfect gift for the gym rat in your life! <a href="#">Shop eGift Cards</a></p>
            </div>
          </div>
